...
/**
 * EnderecoSupermercadoQuery represents the model behind the search form of `app\models\EnderecoSupermercado`.
 */
class EnderecoSupermercadoQuery extends EnderecoSupermercado
{
    /**
     * {@inheritdoc}
     */
